...
const Petcafe = () => {
  ...
  // ✅ FIXED: Updated image paths to match your actual files
  const menuItems = [
    {
      id: 1,
    ...
    },
    {
      ...
      basePrice: 250,
      petType: "dog",
      image: "/src/assets/jell-o.png" // ✅ UPDATED: jell-o.png
    },
    {
      id: 3,
    ...
    },
    {
      ...
      basePrice: 50,
      petType: "dog",
      image: "/src/assets/woofle.jpg", // ✅ UPDATED: woofle.jpg
      hasVariants: true,
      variants: [
    ...
    },
    {
      ...
      basePrice: 95,
      petType: "cat",
      image: "/src/assets/catcupcake.jpg" // ✅ UPDATED: catcupcake.jpg
    },
    {
      id: 15,
      name: "Pet Party Hat",
      ...
      basePrice: 35,
      petType: "all",
      image: "/src/assets/partyhat.png" // ✅ UPDATED: partyhat.png
    },
    {
      id: 16,
      name: "Pet Banner Set",
      ...
      basePrice: 250,
      petType: "all",
      image: "/src/assets/banner.png" // ✅ UPDATED: banner.png (from acc2.jpg)
    },
    {
      id: 17,
      name: "Colored Candle",
      ...
      basePrice: 5,
      petType: "all",
      image: "/src/assets/candle.jpg" // ✅ UPDATED: candle.jpg (from acc3.jpg)
    },
    {
      id: 18,
      name: "Number Candle",
      ...
      basePrice: 18,
      petType: "all",
      image: "/src/assets/numbercandle.jpg" // ✅ UPDATED: numbercandle.jpg (from acc4.jpg)
    },
    {
      id: 19,
      ...
      basePrice: 150,
      petType: "dog",
      image: "/src/assets/pawgurts.png", // ✅ UPDATED: pawgurts.png (from frozen1.jpg)
      hasVariants: true,
      variants: [
  ...
  const showAddedToCartToast = (itemName) => {
    setToastMessage(`Added ${itemName} to cart!`);
    setShowToast(true);
    setTimeout(() => setShowToast(false), 3000);
  };

  const handleAddToCart = (item, variantId = null) => {
    const selectedVariantId = variantId || (item.variants && item.variants[0]?.id) || null;
    const variantData = item.variants?.find(v => v.id === selectedVariantId) || null;

    const price = variantData ? variantData.price : item.basePrice;
    const variantName = variantData
      ? (variantData.flavor || variantData.type || variantData.color || variantData.size)
      : 'Standard';

    const existingItem = cart.find(ci => ci.id === item.id && ci.variantId === selectedVariantId);

    if (existingItem) {
      setCart(cart.map(ci =>
        ci.id === item.id && ci.variantId === selectedVariantId
  ...
  const handleCartQuantityChange = (itemId, variantId, change) => {
  ...
  const handleRemoveFromCart = (itemId, variantId) => {
    setCart(cart.filter(item => !(item.id === itemId && item.variantId === variantId)));
  };
      ...
      <div className="petcafe-hero">
        <div className="petcafe-hero-background">
          <div
            ...
            style={{ backgroundImage: "url('/src/assets/petcafe.jpg')" }}
          />
                      ...
                      <Card.Body className="petcafe-item-body">
                        ...
                        <div className="petcafe-item-buttons">
                          <Button
                            ...
                            onClick={() => handleAddToCart(item, selectedVariant[item.id])}
                          >
                            Add to Cart
                          </Button>
                        </div>
                ...
                <div key={`${item.id}-${item.variantId}`} className="petcafe-cart-item">
                  ...
                  <div className="petcafe-cart-item-details">
                    ...
                    <div className="petcafe-cart-quantity">
                      <Button
                        ...
                        onClick={() => handleCartQuantityChange(item.id, item.variantId, -1)}
                      >
                        -
                      </Button>
                  ...
                  <div className="petcafe-cart-item-actions">
                    <Button
                      ...
                      onClick={() => handleRemoveFromCart(item.id, item.variantId)}
                    >
                      Remove
                    </Button>
                  </div>
