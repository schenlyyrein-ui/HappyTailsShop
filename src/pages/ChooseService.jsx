...
const ChooseService = () => {
  ...
  const handleContinue = () => {
    ...
    // Navigate to groomer selection instead of directly to schedule
    navigate('/groomer-selection', { 
      state: { 
        selectedPets: selectedPets || [],
        petCount: petCount || 0,
        selectedServices: selectedServices,
        ...
        <Row className="ht-service-progress-row">
          <Col>
            <div className="ht-service-progress-steps">
              <ProgressBar now={40} className="ht-service-progress-bar" />
