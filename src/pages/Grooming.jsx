...
const Grooming = () => {
  ...
  const handleLearnMore = () => {
    ...
    alert('Learn More clicked! This would show more information about services.');
  };
          ...
          <div className="grooming-packages-grid">
            ...
            <div className="grooming-package-card">
              ...
              <div className="grooming-package-content">
                ...
                <div 
                  className="grooming-learn-more-card"
                  onClick={handleLearnMore}
                >
                  <p className="grooming-learn-more-text">LEARN MORE</p>
                </div>
              </div>
            </div>
      ...
      <section className="grooming-cat-section">
        <div className="grooming-container">
          <div className="grooming-deluxe-header">
            ...
            <button 
              className="grooming-deluxe-book-button"
              onClick={handleBookAppointment}
            >
              Book Now
            </button>
