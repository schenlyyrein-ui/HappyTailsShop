...
const Shop = () => {
  ...
  const handleAddToCart = (product, variant = null) => {
    const selectedVariantId = variant || (product.variants && product.variants[0]?.id);
    ...
    const variantName = variantData ? variantData.flavor || variantData.scent || variantData.type || variantData.color || variantData.size : 'Standard';
  ...
  return (
    <div className="happy-tails-shop">
      <Container className="happy-tails-shop-container">
        ...
        {/* Products Grid - Updated to center product cards */}
                    ...
                    <Card.Body className="happy-tails-product-body">
                      ...
                      <div className="happy-tails-product-buttons">
                        <Button 
                          ...
                          onClick={() => handleAddToCart(product, selectedVariant[product.id])}
                        >
                          Add to Cart
                        </Button>
                        <Button 
        ...
        {/* Cart Sidebar - Updated with Remove button and removed shipping section */}
        <Modal 
          show={cartVisible} 
