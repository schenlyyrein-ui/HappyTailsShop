...
const Home = () => {
  ...
  const handleBdayPartyClick = () => {
    // Navigate to birthday party page - CORRECTED ROUTE
    navigate('/bdaypawty'); // Changed from '/bday-party' to '/bdaypawty'
  };
  ...
  const handleReserveHotel = () => {
    // Navigate to boarding page from self-service section
    navigate('/boarding');
  };
  ...
  return (
    <div className="home-main-page">
      ...
      {/* Services Section - UPDATED with BDAY PARTY */}
      ...
      {/* Best Selling Products - UPDATED with sales indicators */}
          ...
          <Row className="align-items-center">
            <Col lg={6}>
              <div className="home-favorite-content">
                ...
                <Button className="home-interest-btn">
                  HAVE AN INTEREST?
                </Button>
              </div>
            </Col>
        ...
        <Container>
          <div className="home-self-service-card">
            ...
            <Row className="home-self-service-options">
              ...
              <Col md={3} sm={6} className="mb-3">
                <div className="home-self-service-btn-wrapper">
                  <div 
                    className="home-self-service-btn-bg"
